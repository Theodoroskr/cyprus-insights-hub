...
interface AuthContextType {
  ...
  loading: boolean;
  profile: { display_name: string | null; company: string | null; tier: string } | null;
  signUp: (email: string, password: string, meta?: { full_name?: string; company?: string }) => Promise<void>;
